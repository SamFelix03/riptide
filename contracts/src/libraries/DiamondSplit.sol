...
/// @title DiamondSplit
/// @notice Beta-retention surplus split (LVR_MATH.md §5.3).
library DiamondSplit {
    ...
    function split(uint256 surplusWad, uint256 betaWad) internal pure returns (uint256 payToResolver, uint256 retainToLP) {
        ...
        payToResolver = WadMulDiv.mulDiv(WadMulDiv.WAD - betaWad, surplusWad, WadMulDiv.WAD, WadMulDiv.Rounding.Down);
