...
import { RiptideDutchHandlers } from "./RiptideDutchHandlers.sol";
...
abstract contract RiptideOpcodes is Controls, XYCSwap, Decay, RiptideDutchHandlers {
        ...
        returns (function(Context memory, bytes calldata) internal[] memory result)
    {
        ...
        result[RiptideConstants.OP_DUTCH_AUCTION_BALANCE_IN] = RiptideDutchHandlers._dutchAuctionBalanceIn1D;
        result[RiptideConstants.OP_DUTCH_AUCTION_BALANCE_OUT] = RiptideDutchHandlers._dutchAuctionBalanceOut1D;
    }
}
